<%-- 
    Document   : info
    Created on : 29 Jan, 2017, 4:18:34 PM
    Author     : Pranav
--%>
...
<html>
    ...
    <body>
        ...
        <%
              String p =  session.getAttribute("nm").toString();
             try{
            Class.forName("com.mysql.jdbc.Driver");
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/library","root","8600525761");
            PreparedStatement ps=con.prepareStatement("select * from admin_table where student_name = ?");
            ps.setString(1,p);
